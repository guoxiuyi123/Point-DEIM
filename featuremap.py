...
def get_params():
    params = {
        'config': 'configs/deimv2/deimv2_dinov3_m_coco.yml',
        'weight': 'outputs/deimv2_dinov3_m_coco/best_stg1.pth',
        'device': 'cuda:0',
        'layer': ['backbone.sta.stem.0', 'backbone.sta.conv4.1','encoder.fpn_blocks.0.cv4.conv'],
...
if __name__ == '__main__':
    ...
    model(r'/home/pc/gxy/dataset/coco2017/coco/images/val2017/000000023781.jpg', 'featuremap_result')
