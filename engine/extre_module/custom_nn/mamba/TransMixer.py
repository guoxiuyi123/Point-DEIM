'''
本文件由BiliBili：魔傀面具整理    
engine/extre_module/module_images/CVPR2026-TransMixer.png  
engine/extre_module/module_images/CVPR2026-TransMixer.md
...
if __name__ == '__main__':  
    ...
    module = TransMixerModule(channel).to(device)     
