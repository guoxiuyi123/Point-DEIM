...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', '-i', default="/home/pc/gxy/dataset/coco2017/coco/images/val2017", type=str)
    parser.add_argument('--label_json', '-l', default="/home/pc/gxy/dataset/coco2017/coco/annotations/instances_val2017.json", type=str)
    parser.add_argument('--pred_json', '-p', default="outputs/deimv2_dinov3_m_coco_eval/pred_bbox.json", type=str)
